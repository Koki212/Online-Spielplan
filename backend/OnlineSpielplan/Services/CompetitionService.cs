...
namespace OnlineSpielplan.Services
{
    public class CompetitionService
    {
        ...
        public async Task<Competition?> GetCompetitionByIdAsync(string id) =>
            await _competitionCollection.Find(competition => competition.CompetitionId == id).FirstOrDefaultAsync();
    }
}
